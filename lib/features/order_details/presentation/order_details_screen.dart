                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ExpansionTile(
                      title: Text(
                          state.orderDetails.orderProducts[index].productName),
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                  'Price: \$${state.orderDetails.orderProducts[index].productPrice}'),
                              Text(
                                  'Discount: \$${state.orderDetails.orderProducts[index].productPriceAfterDiscount}'),
                              Text(
                                  'Quantity: ${state.orderDetails.orderProducts[index].orderProductQuantity}'),
                              Text(
                                  'Total: \$${state.orderDetails.orderProducts[index].productTotal}'),
                            ],
                          ),
                        ),
                      ],
